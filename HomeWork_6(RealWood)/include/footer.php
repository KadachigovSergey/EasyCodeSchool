<div class="footer">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <span class="head"><a href="#">Каталог</a></span>
                <ul>
            ...
            <div class="col-sm-3">
                <span class="head"><a href="#">Покупателям</a></span>
                <ul>
            ...
            <div class="col-sm-3">
                <span class="head"><a href="#">Realwood</a></span>
                <ul>
            ...
            <div class="col-sm-3 logo-box">
                ...
                <ul>
                    ...
                    <li><span><a href="#">(123) 456-78-99</a></span><span><a href="#">(123) 456-78-99</a></span></li>
                    <li><a href="#">s-leswood@ya.ru</a></li>
                    <li><a href="#">МО, ПО. Путилково 69км. МКАД,<br>ЗАО Гринвуд, строение 9, оф. 85<br>(от МКАД 200 метров)</a></li>
                </ul>
            </div>
        </div>
    </div>
